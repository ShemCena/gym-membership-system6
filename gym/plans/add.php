...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($plan->create($data)) {
            redirect('index.php', 'Plan added successfully!', 'success');
        } else {
...
<head>
    ...
    <title>Add Plan - Fitness Club Management System</title>
...
<body class="bg-slate-900 text-white">
    ...
    <div class="ml-56 p-4">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-2xl font-bold mb-1">Add New Plan</h1>
                <p class="text-gray-400 text-sm">Create a new membership plan for your fitness club</p>
            </div>
